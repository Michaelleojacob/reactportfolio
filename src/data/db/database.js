  ...
  services: [
    {
      ...
      icon: 'color-pallet',
      details:
        'I love software, I enjoy solving problems, and chasing bugs. I have yet to run into a problem I cant solve.',
    },
    {
  ...
  portfolios: [
    {
      id: 1,
      title: 'BattleShip',
      description: 'The classic board game now on my github',
      subtitle: 'Vanilla js css html. Utilized PubSub',
      imageUrl: './images/portfolio-image-1.jpg',
      largeImageUrl: ['./images/portfolio-image-1-lg.jpg'],
      url: 'https://michaelleojacob.github.io/bsBattleShipV1/',
      repo: 'https://github.com/Michaelleojacob/bsBattleShipV1',
    },
    {
      id: 2,
      title: 'React-Redux Shopping Cart',
      description: 'A simple shopping cart UI that features React and Redux',
      subtitle: 'React, Redux, react-router-dom',
      imageUrl: './images/portfolio-image-2.jpg',
      largeImageUrl: ['./images/portfolio-image-2-lg.jpg'],
      url: 'https://github.com/Michaelleojacob/shopping-cart-redux-router',
      repo: 'https://michaelleojacob.github.io/shopping-cart-redux-router/',
    },
    {
      id: 3,
      title: 'pokememory',
      description: 'charming memory game',
      subtitle: 'React JS',
      imageUrl: './images/portfolio-image-3.jpg',
      largeImageUrl: ['./images/portfolio-image-3-lg.jpg'],
      url: 'https://github.com/Michaelleojacob/pokememory',
      repo: 'https://michaelleojacob.github.io/pokememory/',
    },
    {
      id: 4,
      title: 'CV Maker',
      description:
        'React form that fills out the page as the user completes the forms',
      subtitle: 'React JS',
      imageUrl: './images/portfolio-image-4.jpg',
      largeImageUrl: ['./images/portfolio-image-4-lg.jpg'],
      url: 'https://michaelleojacob.github.io/cv-project',
    ...
    },
    {
      ...
      url: ['https://michaelleojacob.github.io/mytodo/'],
      repo: ['https://github.com/Michaelleojacob/mytodo'],
    },
    {
      id: 6,
      title: 'Weather App',
      description: 'check any location for the weather',
