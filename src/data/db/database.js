...
const database = {
  ...
  services: [
    ...
    },
    {
      ...
      icon: 'mobile',
      details:
        'Create apps and websites that look appealing on mobile interfaces. Through the use of @media and React Native, I am able to make Mobile look simple, intuivite and easy to understand.',
    },
    {
